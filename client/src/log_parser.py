...
class LogParser:
    ...
    def __init__(self, file_name) -> None:
        ...
        self.child_types = [
            r'CubeGame.CardStaged, SecondDinner.CubeGame.Logic'
            r'CubeGame.Card, SecondDinner.CubeGame.Logic',
        ]
    ...
    def extract_remote_game(self, remote_game_json:dict) -> dict:
        ...
        for extract in self.extract_ids(game_state):
            if 'Player' in extract[r'$type']:
                player_id = 1 if game_state['Players'][0][r'$id'] == extract[r'$id'] else 2
    ...
    def extract_ids(self, state:any, result=None):
